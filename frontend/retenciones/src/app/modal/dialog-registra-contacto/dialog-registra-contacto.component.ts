...
export class DialogRegistraContactoComponent implements OnInit {
 ...
 saveContacto(contacto: ContactoFire){
  ...
  saveCargo() {
    ...
    let paramDetObject31 = new ParametroDetalleFire(); paramDetObject31.codigo = 753; paramDetObject31.descripcion = 'ANALISTA DE GESTION retenciones'; paramDetObject31.estado = 'Activo'; paramDetObjectList.push(paramDetObject31);
    ...
    let paramDetObject115 = new ParametroDetalleFire(); paramDetObject115.codigo = 1204; paramDetObject115.descripcion = 'ESPECIALISTA DE GESTION retenciones'; paramDetObject115.estado = 'Activo'; paramDetObjectList.push(paramDetObject115);
    ...
    let paramDetObject148 = new ParametroDetalleFire(); paramDetObject148.codigo = 1270; paramDetObject148.descripcion = 'GERENTE DE PLANIFICACIÓN retenciones Y CONTROL DE GESTIÓN'; paramDetObject148.estado = 'Activo'; paramDetObjectList.push(paramDetObject148);
