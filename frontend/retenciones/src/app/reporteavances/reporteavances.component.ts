...
headingCss = {
  ...
  ngOnInit() {
    ...
    this.callIniciativas("categoria.descripcion;","PROYECTO,MANTENIMIENTO,INCIDENCIA,SOPORTE;");
  } 
  ...
  lista.forEach(iniciativaFire => {
        ...
        if(undefined != iniciativaFire.recursos && 0 != iniciativaFire.recursos.length){
            ...
            if (total>0){
              ...
              actividadFireMonitor.horasavance = '0/' + iniciativaFire.horaReal;  
            }
